   ...
   return (
      <div className="py-6">
         ...
         <div className="p-6 md:px-12 px-6 leading-7">
            <h2 className="text-3xl mb-3">1) Why DerpFest includes GApps by default?</h2>
            ...
            <h2 className="text-3xl mb-3">2) Will there be a Non-GApps version?</h2>

            <p className="mb-3">
            A) No.</p>

            <h2 className="text-3xl mb-3">3) How can I apply for official maintainership for my device?</h2>
            ...
            <h2 className="text-3xl mb-3">4) Where I can find XDA Template for the DerpFest ROM I made?</h2>
